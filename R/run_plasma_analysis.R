...
#'   formatted as:
#'   \itemize{
#'     \item First column = row identifiers as row names. In standard datasets these
#'       are protein identifiers (e.g. UniProt IDs). In this implementation, due to
#'       duplicate entries generated by the proteomics database, row names are
#'       positional labels (e.g. \code{row1}, \code{row2}, \code{row3}) and the
#'       actual protein names are recovered via \code{raw_file}.
